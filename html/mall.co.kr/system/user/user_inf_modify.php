                ...
                <div class="container-fluid">
                    ...
                    <div class="row row-cols-1">
                            ...
                            <div class="text-center">
                                <h1 class="h6 text-gray-900 mb-6">사용자정보를 수정합니다.</h1>
                            </div>
                            <form name="frmData" class="user">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="user_id" name="user_id" value="<?=$user_inf[0]['user_id']?>" readonly placeholder="사용자ID">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="pwd" name="pwd" value="<?=$user_inf[0]['pwd']?>" readonly placeholder="비밀번호">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
