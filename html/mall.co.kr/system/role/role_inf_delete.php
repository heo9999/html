                ...
                <div class="container-fluid">
                    ...
                    <div class="row row-cols-1">
                            ...
                            <div class="text-center">
                                <h1 class="h6 text-gray-900 mb-6">권한을 삭제합니다.</h1>
                            </div>
                            <form name="frmData" id="frmData" class="user">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="role_id" name="role_id" value="<?=$role_inf[0]['role_id']?>" placeholder="권한ID">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="role_nm" name="role_nm" value="<?=$role_inf[0]['role_nm']?>" placeholder="권한명">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="role_ordr" name="role_ordr" value="<?=$role_inf[0]['role_ordr']?>" placeholder="정렬순서">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="role_desc" name="role_desc" value="<?=$role_inf[0]['role_desc']?>" placeholder="설명">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
