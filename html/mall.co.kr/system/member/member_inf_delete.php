                ...
                <div class="container-fluid">
                    ...
                    <div class="row row-cols-1">
                            ...
                            <form name="frmData" id="frmData" class="user">
                                <input type="hidden" id="hospitalNo" name="hospitalNo" value="<?=$member_inf[0]['hospitalNo']?>">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="zipcode" name="zipcode" value="<?=$member_inf[0]['zipcode']?>" placeholder="우편번호">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="addr" name="addr" value="<?=$member_inf[0]['addr']?>" placeholder="주소">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="tel" name="tel" value="<?=$member_inf[0]['tel']?>" placeholder="전화번호">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
