                            ...
                            <form name="frmData" class="user">
                                <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="title" name="title" value="<?=$board_inf[0]['title']?>" placeholder="제목">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col">
                                        <input type="text" class="form-control form-control-user" id="board_ctnt" name="board_ctnt" value="<?=$board_inf[0]['board_ctnt']?>"
                                            placeholder="내용">
                                    </div>
                                </div>
